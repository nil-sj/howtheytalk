...
$workflow = Workflow::load('talknotes_workflow');
if ($workflow) {
  $workflow->delete();
  echo "Deleted old workflow\n";
}
...
echo "States: Draft, Published, Archived\n";
echo "Applies to: Language Entry, Usage Difference, Article\n";
