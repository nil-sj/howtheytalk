...
export default function ShareButtons({ title, url }) {
  ...
  return (
    <div className="share-buttons">
      ...
      <a className="share-btn share-whatsapp" href={whatsappUrl} target="_blank" rel="noopener noreferrer" title="Share on WhatsApp">
      ...
      <a className="share-btn share-twitter" href={twitterUrl} target="_blank" rel="noopener noreferrer" title="Share on X">
      ...
      <a className="share-btn share-facebook" href={facebookUrl} target="_blank" rel="noopener noreferrer" title="Share on Facebook">
